...
<div class="enderecos index content">
    <a href="/venda/enderecos/adicionar/"  class="button" > <img src="/venda/img/inserir.png" class="img-inserir" width="15px;">Inserir</a>
        ...
        <table>
            ...
            <tbody>
                <?php foreach ($enderecos as $endereco): ?>
                    <tr class="tr linha" data-link="<?= '/venda/enderecos/editar/' . $endereco->id ?>">
                        <?php
