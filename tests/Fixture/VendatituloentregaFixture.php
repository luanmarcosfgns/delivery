...
/**
 * VendatituloentregaFixture
 */
class VendatituloentregaFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'vendatituloentrega';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        'pagamentocliente' => ['type' => 'decimal', 'length' => 10, 'precision' => 0, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'titulo' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
